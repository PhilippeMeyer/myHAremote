...
public class ActivityConstants {
  ...
  static final String TAG = "myHA Remote";
  ...
  /** Action Bundle Key **/
    ...
    static final String onSuccess = "on success";
    static final String onFailure = "on failure";
    static final String connectionTo = "Connection to : ";
    static final String connectionSuccess = "Successfull connection";
    static final String connectionNoSuccess = "Unsuccessfull connection";
    static final String replay = "replay";
    static final String macro = "macro";
    static final String notConnected = "Not connected to server!";
    static final String noConformTag = "Tag is not suitable for a toggle button";
